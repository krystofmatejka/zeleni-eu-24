        ...
        <Layout>
            <form onSubmit={async (e) => {
                ...
                >
                    ...
                    <p>Jenže za námi stojí tisíce lidí jako jste vy: lidé kterým není lhostejná ochrana klimatu a přírody, modernizace ekonomiky, lidská práva a svobody nebo ochrana bezpečí a demokracie.</p>
                    ...
                    <div className={styles.container}>
                        ...
                        <label>
                            <Input type='text' placeholder='PSČ' name='zipCode' pattern='[0-9]{3}\s?[0-9]{2}' value={zipCode} onChange={e => setZipCode(e.target.value)}/>
                        </label>
